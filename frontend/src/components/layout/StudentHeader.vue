    ...
    <div class="header-right">
      ...
      <div class="user-menu-container">
        <div class="user-menu-trigger" @click="menuOpen = !menuOpen">
          <div class="avatar student-avatar">{{ userInitials }}</div>
          <div class="user-info">
            <span class="user-name">{{ authStore.user?.full_name || 'Student' }}</span>
        ...
        <div v-if="menuOpen" class="dropdown-menu" @click="menuOpen = false">
          <div class="dropdown-header">
            <p class="dropdown-user-email">{{ authStore.user?.email || 'student@careerpilot.ai' }}</p>
            <p class="dropdown-role">Student Account</p>
          </div>
          <hr />
...
const userInitials = computed(() => {
  const name = authStore.user?.full_name || 'Student'
