...
from app.routers import auth, company, recruiter, jobs, admin, projects, sandbox, notifications
...
app = FastAPI(
    ...
    description="CareerPilot AI - Recruiter, Admin, Project Collaboration, Sandbox & Notification REST API",
    docs_url="/docs",
    redoc_url="/redoc"
)
